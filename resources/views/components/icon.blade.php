...
{{--
    Inline SVG icon set. Bundled rather than fetched from a CDN so the app
    keeps working on shared hosting with no outbound network access.
--}}

@php
    $paths = [
        'gauge'      => '<path d="m12 14 4-4"/><circle cx="12" cy="12" r="9"/><path d="M12 5v2M19 12h-2M5 12h2"/>',
        ...
        'boxes'      => '<path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><path d="M12 22V12"/><path d="m3.3 7 8.7 5 8.7-5"/>',
        ...
        'scan'       => '<path d="M3 7V5a2 2 0 0 1 2-2h2M17 3h2a2 2 0 0 1 2 2v2M21 17v2a2 2 0 0 1-2 2h-2M7 21H5a2 2 0 0 1-2-2v-2"/><line x1="7" x2="17" y1="12" y2="12"/>',
        'barcode'    => '<path d="M3 5v14M7 5v14M11 5v10M15 5v14M18 5v10M21 5v14"/>',
        'qr'         => '<rect width="7" height="7" x="3" y="3" rx="1"/><rect width="7" height="7" x="14" y="3" rx="1"/><rect width="7" height="7" x="3" y="14" rx="1"/><path d="M14 14h3v3h-3zM19 19h2v2h-2zM14 19h2v2h-2zM19 14h2v2h-2z"/>',
