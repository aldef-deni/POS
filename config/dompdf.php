...
return [
    ...
    */
    ...
    // This app has no /public folder — the document root is the project
    // root — so dompdf is pointed there explicitly. Without this the
    // package falls back to base_path('public') and fails to resolve.
